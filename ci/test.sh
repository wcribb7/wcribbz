...
if [ -z "$SKIP_ONLINE_TESTS" ]; then
	...
	export GITTEST_REMOTE_SPEED_SLOW="http://localhost:9000/speed-9600/TestGitRepository"
	export GITTEST_REMOTE_SPEED_TIMESOUT="http://localhost:9000/speed-0.5/TestGitRepository"
	run_test online
