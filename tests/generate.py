...
class TestSuite(object):
    ...
    def write_suite(self):
        ...
        with io.StringIO() as suite_file:
            ...
            suite_file.write("static const size_t _clar_suite_count = %d;\n" % self.suite_count())
            suite_file.write("static const size_t _clar_callback_count = %d;\n" % self.callback_count())
    ...
    def write_header(self):
        ...
        with io.StringIO() as header_file:
            header_file.write("#ifndef _____clar_suite_h_____\n")
            header_file.write("#define _____clar_suite_h_____\n")
